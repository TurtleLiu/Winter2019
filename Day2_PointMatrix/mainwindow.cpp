...
starty=250+(550-heigh*distance)/2;
...
void MainWindow::start2(){
    ...
    starty=250+(550-realh*distance)/2;
    if(startx<0||starty<250){
        QMessageBox::warning(this, tr("警告！"),
                                    tr("图形太大，超出画布范围！"),
                                    QMessageBox::Yes);
